...
class DAPORewardManager(AbstractRewardManager):
    ...
    def __call__(self, data: DataProto, return_dict: bool = False):
        ...
        for i in range(len(data)):
            ...
            if "suppression_attention_score" in data_item.batch:
                suppression_attention_score = data_item.batch["suppression_attention_score"].item()
                if extra_info is None:
                    extra_info = {}
                extra_info["suppression_attention_score"] = suppression_attention_score
            extra_info["response_length"] = valid_response_length.item()
