...
def apply_monkey_patch(
    ...
    if model.config.model_type in ["qwen2_5_vl", "qwen2_vl"]:
        ...
        if use_remove_padding or ulysses_sp_size > 1:
            from verl.models.transformers.qwen2_vl import qwen2_vl_attn_forward, get_full_attention, qwen2_5_vl_attention_forward, qwen2_5_vl_text_model_forward

            Qwen2_5_VLAttention.get_full_attention = get_full_attention
            Qwen2VLAttention.get_full_attention = get_full_attention
            Qwen2_5_VLAttention.forward = qwen2_5_vl_attention_forward
            Qwen2_5_VLTextModel.forward = qwen2_5_vl_text_model_forward
